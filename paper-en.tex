...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}p{.20\textwidth}p{.36\textwidth}p{.37\textwidth}@{}}
    ...
    This work & Trustworthiness, provenance, clip equivalence, and Trustworthiness Path Stability & Interpretable, domain-adaptable credibility measurement\\
    \bottomrule
  \end{tabular}
\end{table*}

Table~\ref{tab:related-gap} summarizes this positioning. The gap addressed in
this paper is not the absence of credibility classifiers or
