...
influence, and $A$ is audience size. These weights were assigned with the
medical-domain expert for this case study. Access to source data and
certification received the highest weights because medical credibility depends
strongly on verifiable evidence and professional credentials. Confidence received
a lower weight to prevent popularity or audience size from dominating the score
in a sensitive health domain. The credibility weights also reflect the expert
criterion that, when provenance is available, stable propagation through
trustworthy accounts should increase the credibility of the original content.
